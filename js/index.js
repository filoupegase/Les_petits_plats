...
import { DataFetcher, buildHashTableForSearchingRecipes } from "./data/dataFetcher.js";
...
const HASH_TABLE_FOR_SEARCHING_RECIPES = buildHashTableForSearchingRecipes(recipesList);
